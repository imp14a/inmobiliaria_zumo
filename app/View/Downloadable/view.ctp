...
<div class="plainContent">
	...
	<div class="document_view">
		<object type="application/pdf" data="/inmobiliaria_zumo/app/webroot/files/<?php echo $downloadable['Downloadable']['file_name'];?>#toolbar=1&amp;navpanes=0&amp; scrollbar=1" width="100%" height="400px">
		<param name="src" value="/inmobiliaria_zumo/app/webroot/files/<?php echo $downloadable['Downloadable']['file_name'];?>#toolbar=1&amp;navpanes=0&amp;scrollbar=1">
	</div>
</div>