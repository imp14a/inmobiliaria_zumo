...
<body>
	<div id="header">
		...
		<div class="userGroupButtons">
			...
			<?php echo $this->Session->read('Auth.User') && $this->Session->read('Auth.User.isAdmin') ? "|".$this->Html->link('Admin', array('controller' => 'InmobiliariaZumo', 'action' => 'panelAdministration')) : ""; ?>
			|
